  ...
  <%
   ...
   %>
    <div id="Modifer">
			...
			<form method="get" action="modifierInv.do" style="margin : 20px;" class="form-group" name="MyForm" id="myForm" onsubmit="return verifyModificationInput(); return true;" >
				<div class="form-group row">
					<div class="col-sm-6 ">
					  <div class="form-group row">
					    <label for="type" class="col-sm-4 text-dark col-form-label">*Code d'inventaire </label>
					    <div class="col-sm-8 float-right">
					      <input type="text" class="form-control" id="mCode"   name="codeInv" /><br />
				...
				<div class="row ">
			 	...
			 	<div class="form-group row">
				    ...
				    <div class="col-sm-10">
				      <textarea type="text" class="form-control" id="mDescription"   name="description"></textarea>
			    </div>
			  </div>
