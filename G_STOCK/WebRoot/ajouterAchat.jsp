...
<html>
  ...
  <%
   ...
   <!------------------------ NavBar champ d'ajout  ------------------------->
	  ...
	  <div class="collapse navbar-collapse" id="navbarSupportedContent">
	    <ul class="navbar-nav mr-auto">
	      <li class="nav-item active text-light">
	        <B>Ajouter une nouvelle achat</B>
	      </li>
	    </ul>
	...
	<!------------------------ Formulaire pour acheter un article   ------------------------->
	
	<form method="get" action="ajouterAchat.do" style="margin : 20px;" class="form-group" name="MyForm" id="myForm" onsubmit="return verifyInput(); return true;" >
		<div class="form-group row">
		    <label for="type" class="col-sm-2 text-dark col-form-label">*Nom d'article</label>
		    <div class="col-sm-10">
